        ...
        for _ in range(simulations):
            ...
            for i, weapon in enumerate(weapons_to_use):
                ...
                if not weapon.torrent:
                    previous_dice, crits, score = calc_hits(
                        atk=previous_dice,
                        score=weapon.score,
                    ...
                    if weapon.sustained_hits != "0" and weapon.sustained_hits != '':
                    ...
                    results[i]["to_hit"] += score

                # Wounds
                previous_dice, crits, *_  = calc_wounds(
                ...
                # Saves
                cover_result = (defender.cover or weapon.indirect) and not weapon.ignore_cover
                previous_dice, crits, score = calc_saves(
